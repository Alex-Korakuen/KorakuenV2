...
export async function GET() {
  ...
  // line_amount, project_code, invoice_number, cost_category, line_description
  //
  ...
  const examples = [
    ...
    `P001,2026-04-02,inbound,BCP Soles,PEN,,OP-445511,false,20512345678,,Cobro cliente,11800.00,PRJ-2026-01,F001-00045,,`,
    // P002 — three-line outbound, Korakuen pays a known vendor with fee + general cost
    `P002,2026-04-03,outbound,BCP Soles,PEN,,TRF-998877,false,20498765432,,Pago proveedor,5900.00,PRJ-2026-01,F001-00089,,`,
    `P002,2026-04-03,outbound,BCP Soles,PEN,,TRF-998877,false,20498765432,,Pago proveedor,12.50,,,Comisiones bancarias,comisión de transferencia`,
    `P002,2026-04-03,outbound,BCP Soles,PEN,,TRF-998877,false,20498765432,,Pago proveedor,100.00,PRJ-2026-01,,Materiales,materiales varios`,
    ...
    `P003,2026-04-04,outbound,,PEN,,TRF-112233,false,20499988877,20111222333,Pago materiales (Partner B),2500.00,PRJ-2026-01,,Materiales,pagó Partner B`,
    // P004 — outbound cash purchase from an informal vendor (contact_ruc BLANK)
    `P004,2026-04-05,outbound,BCP Soles,PEN,,RET-445566,false,,,Compra materiales informal,450.00,PRJ-2026-01,,Materiales,Don Pedro ferretería`,
  ];
